        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class='flex justify-center bg-gray-100 py-10 p-14'>
                <div class='container mx-auto pr-4'>
                    <div class='w-72 bg-white max-w-x5 mx-auto rounded-sm overflow-hidden shadow-lg hover:shadow-2xl transition-duration-500 transform hover:scale-100 cursor-pointer'>
